...
JSUtils.addMethod(GameObject.prototype, "initialize", 
	function(x, y, z, width, height, depth){
		this.id = JSUtils.generateUUID();
		this.origin = new Point3D().initialize(x, y, z);
		this.width = width;
		this.height = height;
		this.depth = depth;
		this.body = null;
...
GameObject.prototype.getCenterZ = function(){
...
* @param {Float} y
*/
GameObject.prototype.addMove = function(x, y, z){
	if(this.body){
		if(this instanceof PolygonObject){
		...
		this.origin.y += y||0;
		this.origin.z += z||0;
		Game.apiHandler.onAddMove(this);
	}
}
...
/**
* Força a atualização de dados internos do objeto. Responsável pela animação em tempo real.
* Este método deve ser sobrescrito nas subclasses.
*
* @author Kevin Eduard Piske
* @method update
*/
GameObject.prototype.update = function(){return null;}